...
const INFLEXION = 0.05; // Tension lines cross at (INFLEXION, 1)
const START_TENSION = 1.0;
const END_TENSION = 0.0;
...
export default class Scroller {
    ...
    getCurrVelocity() {
        return this.mMode === FLING_MODE
            ? this.mCurrVelocity
            : this.mVelocity -
                  (this.mDeceleration * this.timePassed()) / 2000.0;
    }
        ...
        if (timePassed < this.mDuration) {
            switch (this.mMode) {
                ...
                case FLING_MODE:
                    ...
                    this.mCurrVelocity =
                        ((velocityCoef * this.mDistance) / this.mDuration) *
                        1000;
